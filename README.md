...
- **AI Inline Edit + Context Awareness**: `# 대용량 파일 찾기`처럼 `#`으로 시작하는 자연어를 로컬 AI가 셸 명령어로 변환. 현재 프로젝트 타입(Node/Rust/Go 등)과 최근 명령어 히스토리를 자동으로 컨텍스트에 주입해 정확도 향상. ⚡ 팝업 미리보기 후 Tab으로 확정.
