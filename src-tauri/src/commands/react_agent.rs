...
- key_combo({"modifier": "cmd", "key": "k"}) — 단축키 조합 입력 (modifier: cmd/command/meta/super/win/windows, ctrl/control, alt/option, shift; key: 1글자 또는 enter/space/tab/esc/backspace/delete/up/down/left/right(또는 arrowup/arrowdown/arrowleft/arrowright)/home/end/pageup(pgup)/pagedown(pgdn)/f1~f12)"#;
