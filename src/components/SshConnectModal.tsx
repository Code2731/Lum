      ...
      <DialogContent className="sm:max-w-[440px] gap-0 p-0 overflow-hidden border-white/10 rounded-2xl">
        ...
        <form onSubmit={handleSubmit} className="px-5 py-4 space-y-3">
          <div className="flex gap-2">
            <div className="flex-1 space-y-1">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className="pl-8 py-2 rounded-lg font-mono"
                  required
                />
              </div>
            </div>
            <div className="w-20 space-y-1">
              ...
              <Input
                ...
                placeholder="22"
                className="py-2 rounded-lg font-mono text-center"
              />
            </div>
          </div>
          ...
          <label className="flex items-center gap-2 cursor-pointer select-none group">
            <Switch checked={saveProfile} onCheckedChange={setSaveProfile} className="scale-75" />
